...
contextBridge.exposeInMainWorld('amadeus', {
  ...
  minimizeWorkOverlay: (): Promise<boolean> => ipcRenderer.invoke('work-overlay.minimize'),
  closeWorkOverlay: (): Promise<boolean> => ipcRenderer.invoke('work-overlay.close'),
  openChatOverlay: (): Promise<boolean> => ipcRenderer.invoke('chat-overlay.open'),
  minimizeChatOverlay: (): Promise<boolean> => ipcRenderer.invoke('chat-overlay.minimize'),
  closeChatOverlay: (): Promise<boolean> => ipcRenderer.invoke('chat-overlay.close'),
